package com.actorfw.infra.common.util;
...
import com.actorfw.infra.modules.member.Member;
import com.actorfw.infra.modules.xoditionpost.OditionPost;
...
//		1995/10/27 보리.png
		String path = "/factory/workspace/pikachu/resources/uploaded" + "/" + pathModule + "/" + pathDate + "/";
...
//	      여기까지가 실제로 이미지를 물리적으로 저장하는 코드 (메서드)
	    ...
	    public static void PcreatePath (String path) {
	        File uploadPath = new File(path);
