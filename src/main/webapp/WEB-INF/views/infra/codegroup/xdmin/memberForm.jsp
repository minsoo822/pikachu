...
<body style="background-color: black;">
	<form action="/memBer/memberInst">
		<div class="container" style="width: 30%">
			<div class="row">
				<div class="col">
					<div class="row text-center pt-5">
						<div class="col">
							<a href="../main/mainViewForm.html" style="text-decoration: none;">
					...
					<div class="row m-3">
						<div class="col">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="inlineRadioOptions" id="actorCheck" value="option1">
								<label class="form-check-label" for="inlineRadio1"><b>Actor</b></label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="inlineRadioOptions" id="directorCheck" value="option2">
								<label class="form-check-label" for="inlineRadio2"><b style="color: white;">Director</b></label>
							</div>
						</div>
					</div>
					<div class="row mb-1">
					...
					<div class="row mb-1">
						<div class="col">
							...
							<div class="row gx-1">
								<div class="col-4">
									<input type="text" class="form-control" value="년">
								</div>
								<div class="col-4">
								...
								<div class="col-4">
									<input type="text" class="form-control" value="일">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row mb-1">
						<div class="col">
							<div class="row">
								<div class="col" style="color: white;" name="email">본인확인 메일</div>
							</div>
							<div class="row">
								<div class="col">
						...
						<div class="col">
							...
							<div class="row mb-1">
								<div class="col">
									<select class="form-select">
										...
										<option value="370" >리투아니아 +37</option>
							...
							<div class="row mb-1 gx-1">
								...
								<div class="col-4 d-grid">
									<button type="button" class="regFrombutton">인증번호 발송</button>
								</div>
							</div>
							<div class="row mb-4">
								<div class="col">
					...
					<div class="row mb-5">
						<div class="col d-grid mb-5">
							<button type="submit" class="regFrombutton">다음으로</button>
						</div>
					</div>
				</div>
			</div>
